...
public class FxResetCalculationXL {
    ...
    @ExcelFunction(
        value = "og.FxResetCalculation.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("fxResetCalculation")
    })
    public String toString(FxResetCalculation fxResetCalculation) {
        return fxResetCalculation.toString();
    }
}
