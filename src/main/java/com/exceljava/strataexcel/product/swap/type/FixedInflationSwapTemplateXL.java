...
public class FixedInflationSwapTemplateXL {
    ...
    @ExcelFunction(
        value = "og.FixedInflationSwapTemplate.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("fixedInflationSwapTemplate")
    })
    public String toString(FixedInflationSwapTemplate fixedInflationSwapTemplate) {
        return fixedInflationSwapTemplate.toString();
    }
}
