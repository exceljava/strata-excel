...
public class IborIborSwapTemplateXL {
    ...
    @ExcelFunction(
        value = "og.IborIborSwapTemplate.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("iborIborSwapTemplate")
    })
    public String toString(IborIborSwapTemplate iborIborSwapTemplate) {
        return iborIborSwapTemplate.toString();
    }
}
