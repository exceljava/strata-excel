...
public class FixedRateSwapLegConventionXL {
    ...
    @ExcelFunction(
        value = "og.FixedRateSwapLegConvention.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("fixedRateSwapLegConvention")
    })
    public String toString(FixedRateSwapLegConvention fixedRateSwapLegConvention) {
        return fixedRateSwapLegConvention.toString();
    }
}
