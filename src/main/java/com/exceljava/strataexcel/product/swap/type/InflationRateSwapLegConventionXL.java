...
public class InflationRateSwapLegConventionXL {
    ...
    @ExcelFunction(
        value = "og.InflationRateSwapLegConvention.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("inflationRateSwapLegConvention")
    })
    public String toString(InflationRateSwapLegConvention inflationRateSwapLegConvention) {
        return inflationRateSwapLegConvention.toString();
    }
}
