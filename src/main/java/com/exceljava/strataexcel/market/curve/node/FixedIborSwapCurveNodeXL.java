...
public class FixedIborSwapCurveNodeXL {
    private final ExcelAddIn xl;

    public FixedIborSwapCurveNodeXL(ExcelAddIn xl) {
        this.xl = xl;
    }
    
    @ExcelFunction(
        value = "og.FixedIborSwapCurveNode.build",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public FixedIborSwapCurveNode builder(String[] keys, Object[] values) {
        ...
        FixedIborSwapCurveNode.Builder builder = FixedIborSwapCurveNode.builder();
        
        Object template = args.get("template");
        if (null != template) {
            FixedIborSwapTemplate value;
            try {
                value = xl.convertArgument(template, FixedIborSwapTemplate.class);
            } catch (Exception e) {
                throw new IllegalArgumentException("template could not be converted to FixedIborSwapTemplate", e);
            }
    ...
    @ExcelFunction(
        value = "og.FixedIborSwapCurveNode.ofRate",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public FixedIborSwapCurveNode of(FixedIborSwapTemplate template, ObservableId rateId) {
        return FixedIborSwapCurveNode.of(template, rateId);
    }

    @ExcelFunction(
        value = "og.FixedIborSwapCurveNode.ofSpread",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public FixedIborSwapCurveNode of(FixedIborSwapTemplate template, ObservableId rateId, double additionalSpread) {
        return FixedIborSwapCurveNode.of(template, rateId, additionalSpread);
    }

    @ExcelFunction(
        value = "og.FixedIborSwapCurveNode.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("fixedIborSwapCurveNode")
    })
    public String toString(FixedIborSwapCurveNode fixedIborSwapCurveNode) {
        return fixedIborSwapCurveNode.toString();
    }
}
