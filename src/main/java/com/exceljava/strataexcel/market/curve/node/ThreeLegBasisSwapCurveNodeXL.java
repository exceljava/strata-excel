...
public class ThreeLegBasisSwapCurveNodeXL {
    private final ExcelAddIn xl;

    public ThreeLegBasisSwapCurveNodeXL(ExcelAddIn xl) {
        this.xl = xl;
    }
    
    @ExcelFunction(
        value = "og.ThreeLegBasisSwapCurveNode.build",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public ThreeLegBasisSwapCurveNode builder(String[] keys, Object[] values) {
        ...
        ThreeLegBasisSwapCurveNode.Builder builder = ThreeLegBasisSwapCurveNode.builder();
        
        Object template = args.get("template");
        if (null != template) {
            ThreeLegBasisSwapTemplate value;
            try {
                value = xl.convertArgument(template, ThreeLegBasisSwapTemplate.class);
            } catch (Exception e) {
                throw new IllegalArgumentException("template could not be converted to ThreeLegBasisSwapTemplate", e);
            }
    ...
    @ExcelFunction(
        value = "og.ThreeLegBasisSwapCurveNode.ofRate",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public ThreeLegBasisSwapCurveNode of(ThreeLegBasisSwapTemplate template, ObservableId rateId) {
        return ThreeLegBasisSwapCurveNode.of(template, rateId);
    }

    @ExcelFunction(
        value = "og.ThreeLegBasisSwapCurveNode.ofSpread",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public ThreeLegBasisSwapCurveNode of(ThreeLegBasisSwapTemplate template, ObservableId rateId, double additionalSpread) {
        return ThreeLegBasisSwapCurveNode.of(template, rateId, additionalSpread);
    }

    @ExcelFunction(
        value = "og.ThreeLegBasisSwapCurveNode.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("threeLegBasisSwapCurveNode")
    })
    public String toString(ThreeLegBasisSwapCurveNode threeLegBasisSwapCurveNode) {
        return threeLegBasisSwapCurveNode.toString();
    }
}
