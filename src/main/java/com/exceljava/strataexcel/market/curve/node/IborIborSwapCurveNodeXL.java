...
public class IborIborSwapCurveNodeXL {
    private final ExcelAddIn xl;

    public IborIborSwapCurveNodeXL(ExcelAddIn xl) {
        this.xl = xl;
    }
    
    @ExcelFunction(
        value = "og.IborIborSwapCurveNode.build",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public IborIborSwapCurveNode builder(String[] keys, Object[] values) {
        ...
        IborIborSwapCurveNode.Builder builder = IborIborSwapCurveNode.builder();
        
        Object template = args.get("template");
        if (null != template) {
            IborIborSwapTemplate value;
            try {
                value = xl.convertArgument(template, IborIborSwapTemplate.class);
            } catch (Exception e) {
                throw new IllegalArgumentException("template could not be converted to IborIborSwapTemplate", e);
            }
    ...
    @ExcelFunction(
        value = "og.IborIborSwapCurveNode.ofRate",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public IborIborSwapCurveNode of(IborIborSwapTemplate template, ObservableId rateId) {
        return IborIborSwapCurveNode.of(template, rateId);
    }

    @ExcelFunction(
        value = "og.IborIborSwapCurveNode.ofSpread",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
    ...
    public IborIborSwapCurveNode of(IborIborSwapTemplate template, ObservableId rateId, double additionalSpread) {
        return IborIborSwapCurveNode.of(template, rateId, additionalSpread);
    }

    @ExcelFunction(
        value = "og.IborIborSwapCurveNode.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("iborIborSwapCurveNode")
    })
    public String toString(IborIborSwapCurveNode iborIborSwapCurveNode) {
        return iborIborSwapCurveNode.toString();
    }
}
