...
public class TermDepositCurveNodeXL {
    ...
    @ExcelFunction(
        value = "og.TermDepositCurveNode.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("termDepositCurveNode")
    })
    public String toString(TermDepositCurveNode termDepositCurveNode) {
        return termDepositCurveNode.toString();
    }
}
