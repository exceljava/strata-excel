...
public class OvernightIborSwapCurveNodeXL {
    ...
    @ExcelFunction(
        value = "og.OvernightIborSwapCurveNode.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("overnightIborSwapCurveNode")
    })
    public String toString(OvernightIborSwapCurveNode overnightIborSwapCurveNode) {
        return overnightIborSwapCurveNode.toString();
    }
}
