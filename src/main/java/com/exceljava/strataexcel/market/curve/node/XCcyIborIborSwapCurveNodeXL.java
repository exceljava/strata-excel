...
public class XCcyIborIborSwapCurveNodeXL {
    ...
    @ExcelFunction(
        value = "og.XCcyIborIborSwapCurveNode.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("xCcyIborIborSwapCurveNode")
    })
    public String toString(XCcyIborIborSwapCurveNode xCcyIborIborSwapCurveNode) {
        return xCcyIborIborSwapCurveNode.toString();
    }
}
