...
public class IborFixingDepositCurveNodeXL {
    ...
    @ExcelFunction(
        value = "og.IborFixingDepositCurveNode.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("iborFixingDepositCurveNode")
    })
    public String toString(IborFixingDepositCurveNode iborFixingDepositCurveNode) {
        return iborFixingDepositCurveNode.toString();
    }
}
