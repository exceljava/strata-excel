...
public class NotionalScheduleXL {
    ...
    @ExcelFunction(
        value = "og.NotionalSchedule.toString",
        category = "Strata",
        isThreadSafe = true
    )
    @ExcelArguments({
        @ExcelArgument("notionalSchedule")
    })
    public String toString(NotionalSchedule notionalSchedule) {
        return notionalSchedule.toString();
    }
}
